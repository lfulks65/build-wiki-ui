...
/**
 * PageViewer — fetches and renders markdown page content with
 * a scroll-spy Table of Contents in the right sidebar.
 */
      ...
      <div className="flex-1 px-4 py-6 lg:px-6">
        <div className="mx-auto w-full max-w-3xl">
          <MarkdownRenderer
            ...
            className="w-full page-viewer"
          />
        </div>
      </div>

      {/* Table of Contents sidebar */}
      <TableOfContents content={pageContent.content} />
    </div>
  );
}
